...
# def run_sanity_test():
#     print("Sanity Testing Started")
#     print("Checking Login")
#     print("Checking Payment")
#     print("Sanity Testing Completed")
...
# def show_test(feature, status):
#     print(f"{feature} - {status}")

# show_test("Login", "Passed")

# def test_result(name, age):
#     print(f"{name} - {age}")

# test_result("Ranjith", 30)


# Now back to Exercise #3

# def test_result(feature, status):
#     print(f"{feature}  - {status}")

# test_result("Login","Passed")
# test_result("Payment","Failed")
# test_result("Profile","Passed")


# Day 4 — Exercise #4: Condition inside a Function

# def check_test(feature, status):

#         if status == "Passed":
#             print(f"{feature} - Test Successful")
#         else:
#             print(f"{feature} - Test Failed")
# check_test("login", "Passed")
# check_test("Payment","Failed")
# check_test("logout", "Passed")


# Exercise #5 — Function + and

# def check_api(api_name, status, response_time):

#     if status == "Passed" and response_time <= 500:
#         print(f"{api_name} - API Successful")
#     else:
#         print(f"{api_name} - Need API attention")
    

# check_api("Login API", "Passed", 320)
# check_api("Payment API", "Passed", 850)
# check_api("Profile API", "Failed", 400)


# Exercise #6 — One more condition inside a function

# def check_build(failed_tests, critical_bugs):

#     if failed_tests > 3 or critical_bugs > 0 :
#         print(f"Build Blocked")
#     else:
#         print(f"Build Ready")
...
# Day 4 — Next Concept: return

# Exercise #7 — Your first return
...
# result1 = get_test_status("Passed")
# result2 = get_test_status("Failed")

# print(result1)
# print(result2)

# Exercise #8 — Use the returned value
...
# else:
#     print("Not ready for deploy")


# def get_first_name(firstname):
#     if firstname == "Ranjith":
#         return("Yes, this is my name")
#     else:
#         return("not mine")

# new_name = get_first_name("Yes, this is my name")

# if new_name == "Ranjith":
#     print("oh yes, thats my name correct")
# else:
#     print("shit not my name yeah")

# def calculate_pass_percentage(passed_tests, total_tests):
#     passed_percentage = passed_tests / total_tests * 100

#     return  passed_percentage

# percentage = calculate_pass_percentage(90, 100)
# print(f"Pass Percentage: {percentage}%")

# Exercise #10 — Calculation + return + decision

# def get_release_status(passed_tests, total_tests):
#     calculate_percentage = passed_tests / total_tests * 100 

#     if calculate_percentage >= 95 :
#         return ("Release Ready")
#     else:
#         return ("Release Blocked")
    
# result1 = get_release_status(98, 100)
# result2 = get_release_status(80, 100)

# print(result1)
# print(result2)

# Exercise #11 — Function + List

test_results = ["Passed", "Failed", "Passed", "Passed", "Failed"]


# def count_passed_tests(test_results):
#     passed_count = 0
...
# passed_values = count_passed_tests(test_results)
# print(f"Passed Counts {passed_values}")

# Exercise #12 — Return Two Counts
...
# passed_count, failed_count = count_test_results(test_results)

# print(f"Passed Tests: {passed_count}")
# print(f"Failed Tests: {failed_count}")


# # Exercise #13 — Function + List of Dictionaries
# api_results = [
#     {"api": "Login", "status": "Passed", "response_time": 320},
#     {"api": "Payment", "status": "Failed", "response_time": 850},
#     {"api": "Profile", "status": "Passed", "response_time": 450},
#     {"api": "Orders", "status": "Passed", "response_time": 700},
#     {"api": "Logout", "status": "Failed", "response_time": 300}
# ]

# def analyze_api_results(api_results):
#     good_apis = 0
#     need_attention = 0

#     for api_result in api_results:
#         if api_result["status"] == "Passed" and api_result["response_time"] <= 500:
#             good_apis = good_apis + 1
#         else:
#             need_attention = need_attention + 1
#     return good_apis, need_attention

# good_api, need_attent = analyze_api_results(api_results)

# print(f"Good Apis Count : {good_api}")
# print(f"Need Attention : {need_attent}")

# Exercise #14 — Let's reduce the hints


# test_results = [
#     {"feature": "Login", "status": "Passed", "severity": "None"},
#     {"feature": "Payment", "status": "Failed", "severity": "Critical"},
#     {"feature": "Profile", "status": "Passed", "severity": "None"},
#     {"feature": "Checkout", "status": "Failed", "severity": "Major"},
#     {"feature": "Search", "status": "Failed", "severity": "Critical"},
#     {"feature": "Logout", "status": "Passed", "severity": "None"}
# ]
...
#             critical_failed_count = critical_failed_count + 1
        
#     return passed_count, failed_count, critical_failed_count

# total_passed, total_failed, total_critical = analyze_test_results(test_results)
...
# Exercise #15 — Function returns a final decision
...
# def get_release_decision(test_results):
...
# release_status = get_release_decision(test_results)
# print(release_status)


# Exercise #16 — Slightly harder

# api_results = [
#     {"api": "Login", "status": "Passed", "response_time": 300},
#     {"api": "Payment", "status": "Passed", "response_time": 900},
#     {"api": "Profile", "status": "Passed", "response_time": 450}
# ]


# def get_api_health(api_results):

#     for api_result in api_results:
#         if api_result["status"] == "Failed" or api_result["response_time"] > 500:
#             return "API Health Warning"

#     return "All APIs Healthy"

# health = get_api_health(api_results)
# print(health)


# Exercise #17 — Return a Dictionary
...
# Exercise #18 — API Results → Summary Dictionary
...
#     {"api": "Profile", "status": "Passed", "response_time": 450},
#     {"api": "Orders", "status": "Passed", "response_time": 700},
#     {"api": "Logout", "status": "Failed", "response_time": 400}
# ]


# def generate_api_summary(api_results):
#     passed_api = 0
#     failed_api = 0
#     slow_api = 0
...
#             passed_api = passed_api + 1
        
#         if api_result["status"] == "Failed":
#             failed_api = failed_api + 1
        
#         if api_result["response_time"] > 500:
#             slow_api = slow_api + 1
        
#     total_api = passed_api + failed_api 
...
# summary = generate_api_summary(api_results)

# print(f"Passed APIs: {summary['passed']}")
# print(f"Failed APIs: {summary['failed']}")
# print(f"Slow APIs: {summary['slow']}")
# print(f"Total APIs: {summary['total']}")


# # Exercise #19 a mini QA automation challenge.

# test_results = [
#     {"feature": "Login", "status": "Passed", "execution_time": 4},
#     {"feature": "Payment", "status": "Failed", "execution_time": 8},
#     {"feature": "Profile", "status": "Passed", "execution_time": 3},
#     {"feature": "Checkout", "status": "Passed", "execution_time": 7},
#     {"feature": "Search", "status": "Failed", "execution_time": 6},
#     {"feature": "Logout", "status": "Passed", "execution_time": 2}
# ]

# def generate_qa_reports(test_results):
#     passed_test = 0
#     failed_test = 0
#     slow_test = 0
...
#         if test_result ["execution_time"] > 5:
#             slow_test = slow_test + 1
        
#     total_test = passed_test + failed_test

#     pass_percentage = passed_test / total_test * 100

#     if pass_percentage >= 80 and failed_test <= 1:
...
# report = generate_qa_reports(test_results)

# print(report)

# print(f"Total Tests: {report['total']}")
# print(f"Passed Tests: {report['passed']}")
# print(f"Failed Tests: {report['failed']}")
# print(f"Slow Tests: {report['slow']}")
# print(f"Pass Percentage: {report['pass_percentage']:.2f}%")
# print(f"Release Status: {report['release_status']}")


# Day 4 Assessment — Question 1/5
# Interview Scenario: Test Execution Summary
...
#     pass_perecentage = passed_test / total_test * 100
    
#     return { 
#         "passed" : passed_test,
#         "failed" : failed_test,
#         "total"  : total_test,
#         "pass_percentage" : pass_perecentage
#     }
...
# Day 4 Assessment — Question 2/5
# Interview Scenario: API Health Checker

# Requirements:

# An API needs attention if its status is "Failed" OR its response_time is greater than 500.
# Count how many APIs need attention.
# Count how many APIs are healthy.
# If 2 or more APIs need attention, overall health should be "System Warning". Otherwise, "System Healthy".


# api_results = [
#     {"api": "Login", "status": "Passed", "response_time": 250},
#     {"api": "Payment", "status": "Passed", "response_time": 750},
#     {"api": "Profile", "status": "Failed", "response_time": 400},
#     {"api": "Orders", "status": "Passed", "response_time": 480},
#     {"api": "Search", "status": "Failed", "response_time": 900}
# ]

# def check_api_health(api_results):
#     need_attention = 0
#     healthy_api = 0
...
#             need_attention = need_attention + 1
#         else: 
#             healthy_api = healthy_api + 1
    
#     if need_attention >= 2 :
#         overall_health = "System Warning"
#     else:
#         overall_health = "System Healthy"
...
# summary = check_api_health(api_results)

# print(summary)

# print(f"Healthy APIs: {summary['healthy']}")
# print(f"APIs Need Attention: {summary['need_attention']}")
# print(f"Overall Health: {summary['overall_health']}")


# retrive which words are be comes more that 2 times in gmail: ranjithkarnanr@gmail.com using if/else
...
#     charactor_count = text.count(text_char)

#     if charactor_count >=2:
#         print(f"{text_char, charactor_count} - those are print words print 2 times")
#     else:
#         print(f"{text_char, charactor_count} - those are print words print 2 times")
